						...
						<div class="widget-header">
							<div class="widget-toolbar no-border">
								<ul class="nav nav-tabs" id="myTab2">
									<li class="active"><a data-toggle="tab" href="#">修改客户信息</a>
									</li>
								</ul>
							</div>
						</div>

						<form action="${pageContext.request.contextPath }/customer/editCustomer.do" method="post" id="customerID" onsubmit="return toVaild()">
							<input name="token" type="hidden" value="${sessionScope.token }"/>
							<input name="customer_id" type="hidden" value="${customer.customer_id}"/>
							<input name="token.invoke" type="hidden" value="/customer/editCustomer.do"/>
							<table class="table table-bordered">
								<tr>
									<td width="10%" align="right" nowrap="nowrap" bgcolor="#f1f1f1">客户姓名：</td>
									<td width="23%"><input type="text" class=span1-1
										" id="customer_name" name="customer_name" value="${customer.customer_name}"/><font color="red" style=“”>*必填项</font></td>
								...
								<tr>
									...
									<td width="23%"><input type="text" class="span1-1
										" id="customer_phone" name="customer_phone" value="${customer.customer_phone}" /><font color="red" style=“”>*必填项</font></td>
									<td width="10%" align="right" nowrap="nowrap" bgcolor="#f1f1f1">电子邮箱：</td>
									<td width="23%"><input type="text" class="span1-1
										" id="customer_email" name="customer_email" value="${customer.customer_email}"/></td>
								</tr>
								<tr>
									<td width="10%" align="right" nowrap="nowrap" bgcolor="#f1f1f1">常用区间：</td>
									<td width="23%"><input name="customer_destination" type="text"
										id="customer_destination" class=" span1-1" value="${customer.customer_destination}"/></td>
									<td width="10%" align="right" nowrap="nowrap" bgcolor="#f1f1f1">通讯地址：</td>
									<td width="23%"><input type="text" class="span1-1
										" id="customer_address" name="customer_address" value="${customer.customer_address}"/><font color="red" >*必填项</font></td>
								</tr>
								...
								<tr>
									...
									<td width="23%"><select name="customer_gender"
										...
										<c:if test="${customer.customer_gender==2}">
									...
									<td width="23%"><input type="text" class="span1-1"
										name="customer_identity" id="customer_identity" value="${customer.customer_identity}"/><font color="red" >*必填项</font></td>
								</tr>
								...
								<tr>
									...
									<td colspan="3" nowrap="nowrap"><textarea
											...
											style="width: 200px;" value="${customer.customer_remark}"></textarea></td>
								</tr>
							</table>
							<h4>${customer_edit_msg}</h4>
