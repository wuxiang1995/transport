																	  ...
																	  <ul class="pagination">
																	      ...
																	      <c:choose>
																	         <c:when test="${requestScope.page.previous==true }">
																	             <li>
																	               <a href="${pageContext.request.contextPath }/admin/searchAdmin.do?index=${requestScope.page.index-1}&search_thing=${search_thing}" aria-label="Previous">
																	       ...
																	       <c:choose>
																	          ...
																	          <c:when test="${status.count==requestScope.page.index+1}">
							                                                         <%-- 注意事项：数据库的索引是从0开始的，而页面索引是从1开始的。索引数据索引=页面索引-1 --%>
																	      			<li class="active">
																	      			<a href="${pageContext.request.contextPath }/admin/searchAdmin.do?index=${status.count-1}&search_thing=${search_thing}">${status.count }</a>
																	      			</li>										          
																	          </c:when>
																	          <c:otherwise>
																	                <li>
																	    ...
																	    <c:choose>
																	      <c:when test="${requestScope.page.next==true }">
																           <li>
																	      	  <a href="${pageContext.request.contextPath }/admin/searchAdmin.do?index=${requestScope.page.index+1}&search_thing=${search_thing}" 
																	      	      aria-label="Next">
