														...
														<div class="tab-content padding-4">
															...
															<div id="adminAdd" class="tab-pane in active ">
																<div class="scrollable-horizontal" data-size="800">
																    ${requestScope.car_add_msg }
																	<form action="${pageContext.request.contextPath }/car/addCar.do" method="post" class="form-horizontal" role="form">
																		...
																		<div class="form-group">
																			...
																			<div class="col-sm-9">
																				<input name="car_no" type="text" id="form-field-1" placeholder="车辆名" class="col-xs-10 col-sm-5" />
																			</div>
																						<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 车型 </label>

																			<div class="col-sm-9">
																				<input name="car_type" type="text" id="form-field-1" placeholder="车型" class="col-xs-10 col-sm-5" />
																			</div>
																						<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 营业证号 </label>

																			<div class="col-sm-9">
																				<input name="car_license" type="text" id="form-field-1"  class="col-xs-10 col-sm-5" />
																			</div>
																						<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 吨位 </label>

																			<div class="col-sm-9">
																				<input name="car_dun" type="text" id="form-field-1"  class="col-xs-10 col-sm-5" />
																			</div>
																		...
																		<div class="form-group">
																			...
																			<div class="col-sm-7 text-right">
																				<button type="submit" class="btn btn-primary">增加车辆</button>
																			</div>
																		</div>
																	</form>
