														...
														<div class="tab-content padding-4">
															...
															<div id="powerAdd" class="tab-pane in active ">
																<div class="scrollable-horizontal" data-size="800">
																	 ${requestScope.power_add_msg }
																	<form action="${pageContext.request.contextPath }/power/addPower.do" method="post" class="form-horizontal" role="form">
																		...
																		<div class="form-group">
																			...
																			<div class="col-sm-9">
																				<input name="power_name" type="text" id="form-field-1" placeholder="权限名" class="col-xs-10 col-sm-5" />
																			</div>
																		</div>
																		...
																		<div class="form-group">
																			...
																			<div class="col-sm-9">
																				<input name="power_action" type="text" id="form-field-1" placeholder="请求路径" class="col-xs-10 col-sm-5" />
																			</div>
																		</div>
																		<div class="form-group">
