						...
						<form action="${pageContext.request.contextPath }/order/addOrder.do" method="post" onsubmit="return toVaild()" id="OrderID">
							...
							<table class="table table-bordered">
								<tr>
									...
									</select> &nbsp;&nbsp;&nbsp;&nbsp;<a href="${pageContext.request.contextPath }/customer/toCustomerAdd.do">新增客户</a></td>
								...
								<tr>
									...
									<td width="23%"><input type="text"
										...
										style="width: 400px" /><font color="red" >*必填项</font></td>
								</tr>

								<tr>
									<td width="10%" align="right" nowrap="nowrap" bgcolor="#f1f1f1">收货人：</td>
									<td><input type="text" name="order_recievername"
										id="recievername" class=" span2" /><font color="red" >*必填项</font></td>
									<td width="10%" align="right" nowrap="nowrap" bgcolor="#f1f1f1">联系电话：</td>
									<td width="23%"><input type="text"
										name="order_recieverphone" id="recieverphone" class=" span2" /><font color="red" >*必填项</font></td>
								</tr>
								<tr>
							...
							<table class="table table-bordered" id="goodsId">
								...
								<tr id="index0">
									<td align="center"><input type="text"
										name="item_name0" id="item_name1" class=" span2" /><font color="red" >*</font></td>
									<td align="center"><input type="text"
										name="item_num0" id="item_num1"
										class=" span1 text-center" /><font color="red" >*</font></td>
									<td align="center"><input type="text"
										name="item_unit0" id="item_unit1"
										class=" span1 text-center" /><font color="red" >*</font></td>
									<td align="center"><input type="text"
										name="item_pruefee0" id="item_pruefee1"
										class=" span1 text-center" /><font color="red" >*</font></td>
									<td align="center"><input type="text"
										name="item_totalfee0" id="item_totalfee1"
										class=" span1 text-center" /><font color="red" >*</font></td>
									<td align="center"><input type="text"
										name="item_remark0" id="item_remark1"
										class=" span2" /></td>
									<td align="center" bgcolor="#f1f1f1"><img height="20"
							...
							<table class="table table-bordered">
								<tr>
									...
									<td><input type="text" name="pick_transid"
										id="pick_transid" class="span1-1" disabled="disabled" value="" /></td>
								</tr>
								<!-- 快递、客户送达  收件地址等信息 -->
								...
								<tr>
									...
									<td colspan="5" nowrap="nowrap"><input type="text"
										name="remark" id="order_remark" class="span10" /></td>
								</tr>
							</table>
...
<script type="text/javascript">
	...
	<script>
		...
		var pickHtml = '<td align="right" nowrap="nowrap" bgcolor="#f1f1f1">取件地址：</td>'
				+ '<td><input type="text" name="pick_address" id="pick_address" style="width: 270px" class="span1-1" value=""/><font color="red" >*</font></td>'
				+ '<td align="right" nowrap="nowrap" bgcolor="#f1f1f1">联系电话：</td>'
				+ '<td><input type="text" name="pick_phone" id="pick_phone"  class="span1-1" /><font color="red" >*</font></td>'
				+ '<td align="right" nowrap="nowrap" bgcolor="#f1f1f1">取件联系人：</td>'
				+ '<td><input type="text" name="pick_name" id="pick_name" class="span1-1"  /><font color="red" >*</font></td>';
