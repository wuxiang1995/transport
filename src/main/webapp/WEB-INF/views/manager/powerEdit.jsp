												...
												<div class="widget-header">
													...
													<div class="widget-toolbar no-border">
														<ul class="nav nav-tabs" id="myTab2">
															...
															<li>
																<a data-toggle="tab" href="javascript:void(0)" onclick="window.location.href='${pageContext.request.contextPath }/power/toPowerList.do'">列表</a>
															</li>
														</ul>
													</div>
												</div>
														...
														<div class="tab-content padding-4">
															...
															<div id="powerAdd" class="tab-pane in active ">
																<div class="scrollable-horizontal" data-size="800">
																	 ${requestScope.power_edit_msg }
																	<form action="${pageContext.request.contextPath }/power/editPower.do" method="post" class="form-horizontal" role="form">
																	    <input name="power_id" type="hidden" value="${requestScope.power.power_id }">
																		<input name="token" type="hidden" value="${sessionScope.token }">
																		<input name="token.invoke" type="hidden" value="/power/toPowerList.do">
																		<div class="form-group">
																			<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 权限名 </label>

																			<div class="col-sm-9">
																				<input name="power_name" value="${requestScope.power.power_name }" type="text" id="form-field-1" placeholder="权限名" class="col-xs-10 col-sm-5" />
																			</div>
																		</div>
																		...
																		<div class="form-group">
																			...
																			<div class="col-sm-9">
																				<input name="power_action" value="${requestScope.power.power_action }" type="text" id="form-field-1" placeholder="请求路径" class="col-xs-10 col-sm-5" />
																			</div>
										`								</div>
																		<div class="form-group">
																			...
																			<div class="col-sm-9">
																				<select name="modular_id">
																				   <c:forEach var="modular" items="${requestScope.modulars }">
																				     <c:choose>
																				        <c:when test="${requestScope.power.modular_id==modular.modular_id}">
																		...
																		<div class="form-group">
																			...
																			<div class="col-sm-9">
																				...
																				<c:forEach var="isShowStatus" items="${requestScope.isShow }">
																				    <c:choose>
																				        <c:when test="${requestScope.power.power_is_show==isShowStatus.dic_value}">
																				            <option selected="selected" value="${isShowStatus.dic_value }">${isShowStatus.dic_name }</option>
																				        </c:when>
																				        <c:otherwise>
																				             <option value="${isShowStatus.dic_value}">${isShowStatus.dic_name }</option>
																				        </c:otherwise>
																				     </c:choose>
																				   </c:forEach>
																				</select>
																			...
																			<div class="col-sm-9">
																				<select name="power_parent">
																				   ...
																				   <option value="0">顶级菜单</option>
																				     <c:choose>
																				        <c:when test="${requestScope.power.power_id==pageScope.power.power_id }">
