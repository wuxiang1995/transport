					...
					<div class="page-content">
				          			<div class="widget-box transparent" id="widget-box-13">
												<div class="widget-header">
													<h4 class="widget-title lighter">系统模块管理</h4>

													<div class="widget-toolbar no-border">
														<ul class="nav nav-tabs" id="myTab2">
															<li >
																<a data-toggle="tab" href="javascript:void(0)" onclick="window.location.href='${pageContext.request.contextPath }/modular/toModularAdd.do'">增加</a>
															</li>
												...
												<div class="widget-body">
													<div class="widget-main padding-12 no-padding-left no-padding-right">
														<div class="tab-content padding-4">
															...
															<button id="btnDeleteChkModular" class="btn btn-primary" >删除勾选模块</button>
																 ...
																 <table class="table table-striped table-bordered align-center "> 
																   ...
																   <c:forEach var="modular" varStatus="status" items="${requestScope.page.data }">
																    <tr>
																	  <td><input name="modularId" value="${modular.modular_id}" type="checkbox"></td>
																	  <td>${modular.modular_id}</td>
																	  <td>${modular.modular_name}</td>
																	   <td><button class="btn btn-sm btn-primary" onclick="window.location.href='${pageContext.request.contextPath }/modular/toModularEdit.do?modularId=${modular.modular_id}'">更新</button>&nbsp;&nbsp;<button class="btn btn-sm btn-primary" onclick="window.location.href='${pageContext.request.contextPath }/modular/deleteModular.do?modularId=${modular.modular_id}'" >删除</button></td>
																	</tr>
																   <tr>
																   </c:forEach>
																 </table>
...
<![endif]-->
		...
		<script type="text/javascript">
		       ...
		       $("#btnDeleteChkModular").click(function(){
		    	   //alert("--test--");
		    	   //1.获得选中的复选框的值
		    	   var chkModulars= $("input[name='modularId']:checked");
